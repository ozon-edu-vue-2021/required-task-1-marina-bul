...
var renderPictures = function renderPictures(list) {
  ...
  var link = templateImageCard.content.querySelector("a");
  var image = templateImageCard.content.querySelector("img");
  var fragment = document.createDocumentFragment();
  list.forEach(function (element) {
    link.href = element.url;
    link.dataset.id = element.id;
    image.src = cropImage(element.download_url, 5);
    image.alt = element.author; // image.classList.add("preview");
...
var renderPopupPicture = function renderPopupPicture(picture) {
  var img = templateImagePopup.content.querySelector("img");
  var link = templateImagePopup.content.querySelector("a");
  var author = templateImagePopup.content.querySelector(".author");
  img.src = cropImage(picture.download_url, 2);
  img.alt = picture.author;
  author.textContent = picture.author; // Позволяет вертикальным картинкам не выходить за высоту контейнера
...
var actionHandler = function actionHandler(evt) {
  ...
  if (nextPage > MAX_PAGE_IMAGES) {
    console.warn("WARN: You are trying to call a page that exceeds ".concat(MAX_PAGE_IMAGES));
...
initialState();
},{}],"C:/Users/bragi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/bragi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/index.js"], null)
